...
def leia_võitja(käed):
    ...
    uus_järjestus = []
    if len(käed) == 2:
        if käed[0][0] > käed[1][0]:
            print('1. mängija võitis')
        elif käed[0][0] < käed[1][0]:
            print('2. mängija võitis')
        elif käed[0][0] == käed[1][0]:
            if suurus.index(käed[0][1]) > suurus.index(käed[1][1]):
                print('1. mängija võitis')
            elif suurus.index(käed[0][1]) < suurus.index(käed[1][1]):
                print('2. mängija võitis')
            else:
